...
%changelog
* Mon Dec 12 2016 Thornton Prime <thornton.prime@gmail.com> [0.3.1-2.fdm]
- Rebuild to avoid binary conflict with jd
...
%install
%{__install} -D bin/jd ${RPM_BUILD_ROOT}%{_bindir}/tjd
