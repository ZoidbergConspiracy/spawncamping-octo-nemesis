...
%define python_package tosheets
%define git_path kren1/%{python_package}
...
Version: %{git_version}.git%( echo %{git_tag} | cut -c 1-8 )
Release: 1.fdm
Epoch: %( date +"%Y%m%d" )
...
%changelog
* Mon Nov 20 2017 Thornton Prime <thornton.prime@gmail.com> [0.0]
- Initial 0.0

%description
Pend Stdin to Google Sheet.
