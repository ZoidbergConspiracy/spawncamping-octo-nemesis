...
Source0: http://haproxy.1wt.eu/download/1.5/src/haproxy-1.5-dev22.tar.gz
Source1: haproxy.init
Source2: haproxy.cfg
Source3: haproxy.logrotate

#Patch0: haproxy-1.4.git-dc80672211.patch
...
make %{?_smp_mflags} CPU="generic" TARGET="linux26" USE_PCRE=1 ${use_regparm} USE_OPENSSL=1 USE_ZLIB=1
...
%attr(-,%{haproxy_user},%{haproxy_group}) %{haproxy_datadir}

%changelog
* Mon Jul 22 2013 Thornton Prime <thornton.prime@gmail.com> - 1.5dev19-1.fdm
- Development version including SSL support
