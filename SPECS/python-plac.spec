Name: python-plac
Summary: Python smart command line parsing
License: MIT
URL: https://github.com/k-bx/python-plac
Group: Development/Tools

Packager: Thornton Prime <thornton.prime@gmail.com>
Distribution: FDM

%define python_package plac
%define git_package micheles/plac
...
%description
iSmartest command line argument parsing.
